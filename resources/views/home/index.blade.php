...
@section('contenido')
    ...
    <div id="carruselPresentacion" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item" data-bs-interval="5000">
                <div class="overlay-image" style="background-image: url({{asset('/img/Slides/tecnologia.jpg') }});"></div>
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item" data-bs-interval="10000">
                <div class="overlay-image" style="background-image: url({{asset('/img/Slides/nuestraBandera.jpg') }});"></div>
                <div class="carousel-caption d-none d-md-block">
                    <h4>¡Somos México!</h4>
    ...
    <div class="contenedor">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-2 row-cols-xl-4 align-items-center">
    ...
    <!-- LogIn sección -->
    <div id="login" style="margin-top: 10vh;"></div>
    <div class="loginCuentas">
        <div class="cabecera text-center familyArima" style="background-color:#8C3D20; border: 5px solid #682d18;">
            Iniciar Sesión
        </div>
        <div class="row align-items-center">
            <a href="login?cuenta=alumno" class="col vinculoCuenta">
                <div class="text-center textoCuentas">Alumnos</div>
                <div class="cuadroImagen mx-auto" style="background-image: url({{asset('/img/Cuentas/alumnosCuenta.jpg') }});">
                </div>
            </a>
            <a href="login?cuenta=padre" class="col vinculoCuenta">
                <div class="text-center textoCuentas">Padres</div>
                <div class="cuadroImagen mx-auto" style="background-image: url({{asset('/img/Cuentas/padresCuenta.jpg') }});">
                </div>
            </a>
            <a href="login?cuenta=maestro" class="col vinculoCuenta">
                <div class="text-center textoCuentas">Maestros</div>
                <div class="cuadroImagen mx-auto" style="background-image: url({{asset('/img/Cuentas/maestrosCuenta.jpg') }});">
                </div>
            </a>
            <a href="login?cuenta=tutor" class="col vinculoCuenta">
                <div class="text-center textoCuentas">Tutores</div>
                <div class="cuadroImagen mx-auto" style="background-image: url({{asset('/img/Cuentas/tutoresCuenta.jpg') }});">
                </div>
            </a>
        </div>
    </div>
    ...
    <div class="loginCuentas">
        <div class="cabecera text-center familyArima" style="background-color:#CE1127; border: 5px solid #8b0b1a;">
            Regístrate
        </div>
        <div class="row align-items-center">
